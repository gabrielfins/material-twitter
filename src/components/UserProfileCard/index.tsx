        ...
        <div className="user-profile-card">
            ...
            <div className="accounts-dropdown-container">
                <div className="accounts-dropdown-content">
                    <button className="md-ripples accounts-dropdown-button" onClick={() => setDropdownOpen(!isDropdownOpen)}>
                    ...
                    <div className={`accounts-dropdown ${isDropdownOpen ? 'open' : 'close'}`}>
                        <button className="md-ripples current-account-button">
                        ...
                        <button className="md-ripples other-accounts-button">
                            <span>Usuário</span><p>@usuario</p>
                        </button>
                        <button className="md-ripples accounts-button">Adicionar outra conta</button>
                        <button className="md-ripples accounts-button">Sair desta conta</button>
                    </div>
                </div>
            </div>
            <div className="profile-card-account-info">
                <button className="md-ripples profile-card-account-info-button">
                    <span>Tweets</span>
                    <p>3.671</p>
                </button>
                <button className="md-ripples profile-card-account-info-button">
