                ...
                <div className="tweet-modal-container">
                    ...
                    <div className="tweet-modal">
                        <div className="close tweet-modal-row">
                            <button className="ripple-effect ripples-blue tweet-modal-close-button" onClick={ ()=> setModalOpen(!isModalOpen) }><MdClose size="1.7em" /></button>
                        </div>
                        <div className="divider"></div>
                        <div className="tweet-info tweet-modal-row">
                            ...
                            <div className="tweet-modal-column">
                                ...
                                <div className="normal tweet-modal-row">
                                    <button className="ripple-effect ripples-blue answer-select"><BiWorld className="answer-select-icon" size="1.3em" />Qualquer um pode responder</button>
                                </div>
                                <div className="divider"></div>
                                <div className="normal tweet-modal-row">
                                    <button className="ripple-effect ripples-blue tweet-modal-icon-button"><MdImage size="1.6em" /></button>
                                    <button className="ripple-effect ripples-blue tweet-modal-icon-button"><MdGif size="1.6em" /></button>
                                    <button className="ripple-effect ripples-blue tweet-modal-icon-button"><BiPoll size="1.6em" /></button>
                                    <button className="ripple-effect ripples-blue tweet-modal-icon-button"><HiOutlineEmojiHappy size="1.6em" /></button>
                                    <button className="ripple-effect ripples-blue tweet-modal-icon-button"><IoCalendarSharp size="1.6em" /></button>
